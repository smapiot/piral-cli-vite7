...
The `piral-cli` plugin for using `vite` (**version 7**) as bundler. For version 4 of `vite` use [`piral-cli-vite`](https://github.com/smapiot/piral-cli-vite). For version 5 of `vite` use [`piral-cli-vite5`](https://github.com/smapiot/piral-cli-vite5). For version 6 of `vite` use [`piral-cli-vite6`](https://github.com/smapiot/piral-cli-vite6).
